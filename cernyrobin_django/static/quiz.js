document.addEventListener('DOMContentLoaded', function () {
    ...
    const questionApiPath =
        window.location.origin + '/kafka/quiz/questions?topic=' + topicSlug
    const topicApiPath =
        window.location.origin + '/kafka/quiz/info?topic=' + topicSlug
    let questions = []
    ...
    function checkAnswer(answer) {
        ...
        if (currentQuestionIndex < questions.length) {
            ...
            document.getElementById('user-answer-container').style.display =
                'none'

            document.getElementById('video-name').innerText =
                'Dokončil jsi ' + titleText
        }
    }
    ...
    fetch(topicApiPath)
        ...
        .then((data) => {
            ...
            document.getElementById('video-name').innerText =
                document.getElementById('video-name').innerText + ' ' + topic
            console.log(topic)
        })
        .catch((error) => {
